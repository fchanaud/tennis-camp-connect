  ...
  try {
    ...
    const { data: campData, error: campError } = await supabase
      ...
      .insert({
        ...
        accommodation_name: (packageType !== 'tennis_only') ? accommodationName : null,
        accommodation_phone: (packageType !== 'tennis_only') ? accommodationPhone : null,
        accommodation_map_link: (packageType !== 'tennis_only') ? accommodationMapLink : null,
        accommodation_photo_url: (packageType !== 'tennis_only') ? accommodationPhotoUrl : null,
